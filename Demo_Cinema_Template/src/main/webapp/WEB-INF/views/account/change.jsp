	...
	<div class="row">
		...
		<div class="col-3 col-md-3 col-lg-3"
			...
			<s:form method="post" modelAttribute="user"
				...
				action="${pageContext.request.contextPath }/account/change">
				...
				<div class="form-group">
					...
					<s:input class="form-control" path="email" placeholder="email ..."
						required="required" />
					<br>
				...
				<div class="form-group">
					...
					<fmt:formatDate value="${ user.birthday }" var="date"
						pattern="dd/MM/yyyy" />
					<s:input type="text" class="form-control" path="birthday" id="birthday"
						value="${ date }"/>
					<s:errors style="color:red;" path="birthday"></s:errors>
				</div>
				<div class="form-group">
					...
					Female<br>
					<s:errors style="color:red;" path="gender"></s:errors>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<br>
					<s:errors style="color:red;" path="confirmPassword"></s:errors>
				</div>
