...
<div class="login-box">
  <div class="login-logo">
    <a href="${ pageContext.request.contextPath }/resources/admin/index2.html"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Sign in to start your session</p>
		${ msg }
      <form action="${ pageContext.request.contextPath }/dashboard/process-login" method="post">
